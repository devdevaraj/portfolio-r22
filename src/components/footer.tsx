      ...
      <div className="flex flex-col gap-5 md:items-end">
       <div className="flex flex-col gap-5 w-full md:w-auto">
        ...
        <ul className="flex flex-col gap-4">
         <li>
          <a href="mailto:hello@devaraj.dev" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm flex items-center gap-4 group justify-start md:justify-end">
           <span className="hidden md:inline-block">hello@devaraj.dev</span>
           ...
           <span className="md:hidden">hello@devaraj.dev</span>
          </a>
         </li>
         <li>
          <a href="tel:+919876543210" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm flex items-center gap-4 group justify-start md:justify-end">
           <span className="hidden md:inline-block">+91 987 654 3210</span>
           <span className="bg-slate-800/80 p-2 rounded-full border border-slate-700/50 group-hover:bg-cyan-900/50 group-hover:border-cyan-500/50 transition-all shadow-sm">
           ...
           <span className="md:hidden">+91 987 654 3210</span>
          </a>
         </li>
         <li className="flex gap-4 mt-2 justify-start md:justify-end">
          <a href="https://github.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyan-400 transition-all p-3 border border-slate-700/50 bg-slate-800/80 rounded-full hover:bg-cyan-900/50 hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] hover:-translate-y-1">
           <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
          </a>
          <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyan-400 transition-all p-3 border border-slate-700/50 bg-slate-800/80 rounded-full hover:bg-cyan-900/50 hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] hover:-translate-y-1">
           <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
          </a>
          <a href="https://buymeacoffee.com" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-cyan-400 transition-all p-3 border border-slate-700/50 bg-slate-800/80 rounded-full hover:bg-cyan-900/50 hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.4)] hover:-translate-y-1">
